...
import com.example.kotlinseries.KEY_EVENT_ACTION
import com.example.kotlinseries.KEY_EVENT_EXTRA
import com.example.kotlinseries.R
import com.example.kotlinseries.databinding.CameraUiContainerBinding
import com.example.kotlinseries.databinding.FragmentCameraBinding
import com.example.kotlinseries.util.MediaStoreUtils
...
//            )
            findNavController().navigate(R.id.action_cameraFragment_to_cameraPermissionsFragment)
        }
    }
...
//        val viewFinder1 = fragmentCameraBinding.viewFinder
//
//        val display1 = viewFinder1.display
//        val displayId1 = display1.displayId
//        if (display1 !=null){
//
...
////                        )
////                        )
//                    val action = CameraFragmentDirections.actionCameraFragmentToAddHouseFragment(
//                        getString(R.string.add_fragment_title),"",mediaStoreUtils.mediaStoreCollection.toString())
